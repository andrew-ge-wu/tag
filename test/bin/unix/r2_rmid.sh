...
exec rmid -log $LOG -J-Djava.security.policy=$PCY -J-Djava.rmi.server.logCalls=true -J-Djava.net.preferIPv4Stack=true -J-Djava.rmi.server.useCodebaseOnly=false
